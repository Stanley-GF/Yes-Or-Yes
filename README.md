# YesOrYes
Execute admin command with forcing "yes" windows button (for be admin)

# [Download the builder](https://github.com/Stanley-GF/Yes-Or-Yes/releases/download/YesOrYes/AdminOrBan.exe)
